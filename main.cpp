...
int main(int argc, char *argv[])
{
    ...
    manager.setMainQMLFile("file:///E:/Development/Playground/Yumurta/qml/main.qml");
    engine.rootContext()->setContextProperty("QM", &manager);
    engine.rootContext()->setContextProperty("QML_DEBUG", true);
    engine.load(QUrl(QStringLiteral("file:///E:/Development/Playground/Yumurta/qml/main.qml")));
#else
